...
def randomly_rotate_adsorbate(
    ...
    assert mode in ["random", "heuristic", "random_site_heuristic_placement", "llm-guided_site_heuristic_placement"]
    ...
    elif mode in ["heuristic", "random_site_heuristic_placement", "llm-guided_site_heuristic_placement"]:
...
def rotate_adsorbate(adsorbate, axis, angle, center):
    adsorbate_rotated = adsorbate.copy()
    adsorbate_rotated.rotate(angle, axis, center)
    return adsorbate_rotated

# # Objective function to minimize the z-difference
# def z_diff_objective(angle):
#     adsorbate_rotated = rotate_adsorbate(chosen_adsorbate, chosen_rotvec, angle, placement_center)
#     com = adsorbate_rotated.get_center_of_mass()
#     rot_pos1, rot_pos2 = adsorbate_rotated.positions[binding_idx]
