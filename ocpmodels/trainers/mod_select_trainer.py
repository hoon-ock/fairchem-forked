...
@registry.register_trainer("select")
class EnergyTrainer(BaseTrainer):
    ...
    def _compute_loss(self, out, batch_list):
        ...
        #key = [ads_combo[:,0] == ads_combo[:,1]] or ([bulk_combo[:,0] == bulk_combo[:,1]] and [surf_combo[:,0] == surf_combo[:,1]])
        #import pdb; pdb.set_trace()
        ##################################################################
