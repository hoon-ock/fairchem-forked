...
@registry.register_trainer("list2")
class EnergyTrainer(BaseTrainer):
    ...
    def _compute_loss(self, out, batch_list):
        ...
        # Py = torch.exp(target_normed)/torch.exp(target_normed).sum()
        Py = torch.exp(energy_target/std)/torch.exp(energy_target/std).sum()
